                  ...
                  <CardContent className="pt-4">
                    <ul className="space-y-2">
                      <li>
                        ...
                        >
                          olympus.herokuapp.com
                        </a>
                      </li>
                      <li>
                        <strong>Github: </strong>
                        <a
                          href="https://github.com/hoeferg/Olympus-Project2"
                          className="text-blue-600 hover:underline"
                        >
                          https://github.com/hoeferg/Olympus-Project2
                        </a>
                      </li>
                      <li>
                        <strong>Summary: </strong>A quiz game where users answer
                        questions to prevent disaster on the Olympus Space
                        Station
                      </li>
                      <li>
                        <strong>Role: </strong>Stripe incorporation, full stack
                        development
                      </li>
                      <li>
                        <strong>Tools: </strong>Stripe, MongoDB, React, GraphQL
                      </li>
                    </ul>
                  </CardContent>
                </Card>
                    ...
                    <ul className="space-y-2">
                      <li>
                        ...
                        <a
                          ...
                          className="text-blue-600 hover:underline"
                        >
                          hoeferg.github.io/Ecommerce
                        </a>
                      </li>
                      <li>
                        <strong>Github: </strong>
                        <a
                          href="https://github.com/hoeferg/Ecommerce"
                          className="text-blue-600 hover:underline"
                        >
                          https://github.com/hoeferg/Ecommerce
                        </a>
                      </li>
                      <li>
                        <strong>Summary: </strong>
                        An ecommerce website that contains sample data analytics
                        for a business
                      </li>
                      <li>
                        <strong>Role: </strong>Styled front end and managed
                        quality control
                      </li>
                      <li>
                        <strong>Tools: </strong>React, Github Pages, Node,
                        Material UI
                      </li>
                    </ul>
                  </CardContent>
                    ...
                    <ul className="space-y-2">
                      <li>
                        ...
                        <a href="#" className="text-blue-600 hover:underline">
                          https://github.com/hoeferg/e-commerce
                        </a>
                      </li>
                      <li>
                        <strong>Summary: </strong>
                      ...
                      <li>
                        <strong>Role: </strong>Designed and created database
                      </li>
                      <li>
                        <strong>Database Tools: </strong>HTML, CSS, JavaScript,
                        jQuery, Node
                      </li>
                    </ul>
                  </CardContent>
            ...
            <section>
              ...
              <div className="space-y-4">
                {[
                  ...
                  { name: "API Generation", proficiency: 90 },
